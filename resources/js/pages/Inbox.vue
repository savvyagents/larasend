    ...
    >
        ...
        >
            ...
            <Link
                ...
                class="ml-auto inline-flex items-center gap-2 rounded-md border border-zinc-200 px-3 py-1.5 text-xs font-semibold text-zinc-600 transition hover:bg-zinc-100 dark:border-[#1d2125] dark:text-zinc-300 dark:hover:bg-[#16191c]"
            >
                    ...
                    >
                        ...
                        >
                            <span
                                ...
                                :key="attachment.filename ?? 'attachment'"
